...
import { PlusIcon, PlusIconBlue } from "../svg";

export const RecordsLeft = () => {
  return (
    <div className="max-w-[260px] w-full py-6 px-4 border border-base200 bg-[#F9FAFB] rounded-xl flex flex-col items-start gap-6">
